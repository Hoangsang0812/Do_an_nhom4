						...
						<div class="product-view-content">
							...
							<div class="actions-qty">
								...
								if($row['number'] - $row['number_buy']==0 || $row['status'] == 0){
									...
									<button class="button btn-cart add_to_cart_detail detail-button" title="Mua ngay" type="submit" aria-label="Mua ngay" class="fa fa-shopping-cart" onclick="onAddCart('.$row['id'].')"> Thêm vào giỏ</button>
								</div>';
								}
								?>
							</div>
