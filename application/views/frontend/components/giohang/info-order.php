    ...
    <div class="container">
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                <form action="info-order" enctype="multipart/form-data" method="POST" accept-charset="utf-8" name='info-order' novalidate>
                    <?php
                                ...
                                <table class="table tinfo" style="width: 80%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên" name="name" value="<?php if ($this->session->userdata('sessionKhachHang')) echo $info['username'] ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="<?php if ($this->session->userdata('sessionKhachHang')) echo 'tv';
                                                                                                else echo 'email' ?>" value="<?php if ($this->session->userdata('sessionKhachHang')) echo $info['email'] ?>" placeholder="Email">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Số điện thoại" name="phone" value="<?php if ($this->session->userdata('sessionKhachHang')) echo $info['phone'] ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="city" id="province" class="form-control next-select">
                                                    ...
                                                    foreach ($list as $row) : ?>
                                                        <option value="<?php echo $row['id']; ?>" <?php if ($this->session->userdata('sessionKhachHang')){ if ($row['id'] == $info['cityid']) echo 'selected'; }?>><?php echo $row['name']; ?></option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select name="DistrictId" id="district" class="form-control next-select">
                                                    <?php
                                                    $list2 = $this->Mdistrict->district_id($info['DistrictId']);
                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="address" placeholder="Địa chỉ giao hàng:" class="form-control" rows="4" style="height: auto !important;" value="<?php if ($this->session->userdata('sessionKhachHang')) echo $info['address'] ?>" />
...
<script>
    $(document).ready(function() {
        $('#province').change(function() {
            ...
            if (provinceid != '') {
                $.ajax({
                    url: "<?php echo base_url(); ?>Giohang/info_order",
                    method: "POST",
                    data: {
