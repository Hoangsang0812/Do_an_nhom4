						...
						<div class="box-body">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="email" style="width:100%" value=" <?php echo $row['email'] ?>" />
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Câu trả lời<span class="maudo"></span></label>
									<textarea rows="10" cols="20" name="tl" style="width:100% ;height:100%" id="tl" class="form-control"><?php echo set_value('tl') ?></textarea>

								</div>
								<div class="error" id="username_error"><?php echo form_error('tl')?></div>

								
								<button style="margin-left: 40%;" type="submit" class="btn btn-primary btn-sm">
